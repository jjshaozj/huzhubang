...
public class LoginActivity extends AppCompatActivity {
    ...
    String userID = "";
    String password = "";
    SharedPreferences pref;             //获取数据
    SharedPreferences.Editor editor;    //实现修改
    ...
    public void onClick(View view) {//根据xml文件中按钮的id来判断点击了哪个按钮，并进行相关响应
        switch (view.getId()) {
            case R.id.fab:
